		...
		if (controls.ACCEPT)
		{
			switch (options[curSelected])
			{
				case 'Chart Editor': // felt it would be cool maybe
					CoolUtil.switchStateAndStopMusic(() -> new ChartingState(), false);
				case 'Character Editor':
					CoolUtil.switchStateAndStopMusic(() -> new CharacterEditorState(Character.DEFAULT_CHARACTER, false));
				case 'Week Editor':
					FlxG.switchState(() -> new WeekEditorState());
				case 'Menu Character Editor':
					FlxG.switchState(() -> new MenuCharacterEditorState());
				case 'Dialogue Editor':
					CoolUtil.switchStateAndStopMusic(() -> new DialogueEditorState(), false);
				case 'Dialogue Portrait Editor':
					CoolUtil.switchStateAndStopMusic(() -> new DialogueCharacterEditorState(), false);
