...
class NotesSubState extends MusicBeatSubstate
{
	...
	public function new()
	{
		...
		copyButton = new FlxSprite(760, 50).loadGraphic(Paths.image('editors/noteColorMenu/copy'));
		copyButton.alpha = 0.6;
		add(copyButton);
		
		pasteButton = new FlxSprite(1180, 50).loadGraphic(Paths.image('editors/noteColorMenu/paste'));
		...
		colorPalette = new FlxSprite(820, 580).loadGraphic(Paths.image('editors/noteColorMenu/palette', false));
		colorPalette.scale.set(20, 20);
		colorPalette.updateHitbox();
		colorPalette.antialiasing = false;
		add(colorPalette);
		
		colorWheel = new FlxSprite(860, 200).loadGraphic(Paths.image('editors/noteColorMenu/colorWheel'));
	...
	public function spawnNotes()
	{
		...
		skinNote = new FlxSprite(48, 24).loadGraphic(Paths.image('editors/noteColorMenu/' + (onPixel ? 'note' : 'notePixel')), true, res, res);
		...
		for (i in 0...3)
		{
			var newNote:FlxSprite = new FlxSprite(230 + (100 * i), 100).loadGraphic(Paths.image('editors/noteColorMenu/' + (!onPixel ? 'note' : 'notePixel')), true, res, res);
