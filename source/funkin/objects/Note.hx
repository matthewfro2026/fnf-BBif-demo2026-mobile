...
class Note extends FlxSprite
{
	...
	public var child:Note; // DATA TEST
	...
	public static var colNoteArray:Array<String> = ['left', 'down', 'up', 'right'];
	public static var defaultNoteSkin(default, never):String = 'noteSkins/default';
	...
	public static var OFFSET_X:Float = 0;
	...
	private function set_noteType(value:String):String
	{
		...
		if (noteData > -1 && noteType != value)
		{
			switch (value)
			{
				...
				case "Invisible Note":
					if (!inEditor) visible = false;
					noteSplashData.disabled = true;
					
				case 'GF Sing':
					gfNote = true;
				case 'BF Sing':
					bfNote = true; // why? becuz gf section SUCKS
				case 'Both Sing':
					bothNote = true;
			}
	...
	function loadNoteAnims()
	{
		if (isSustainNote)
		{
			...
			animation.addByPrefix(colArray[noteData] + 'holdend', colNoteArray[noteData] + ' hold end', 24, true);
			animation.addByPrefix(colArray[noteData] + 'hold', colNoteArray[noteData] + ' hold piece', 24, true);
		}
		else animation.addByPrefix(colArray[noteData] + 'Scroll', colNoteArray[noteData] + '0');
