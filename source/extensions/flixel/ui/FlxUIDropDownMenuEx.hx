...
/*
	...
	THIS IS AN EDIT OF FlxUIDropDownMenuEx I'VE MADE BECAUSE I'M TIRED OF IT NOT SUPPORTING SCROLLING UP/DOWN
	BAH!
...
class FlxUIDropDownMenuEx extends FlxUIGroup implements IFlxUIWidget implements IFlxUIClickable implements IHasParams
{
	...
	public var dropDirection(default, set):FlxUIDropDownMenuExDropDirection = Down;
	
	private function set_dropDirection(dropDirection):FlxUIDropDownMenuExDropDirection
	{
	 ...
	 */
	public function new(X:Float = 0, Y:Float = 0, DataList:Array<StrNameLabel>, ?Callback:String->Void, ?Header:FlxUIDropDownHeader, ?DropPanel:FlxUI9SliceSprite, ?ButtonList:Array<FlxUIButton>, ?UIControlCallback:Bool->FlxUIDropDownMenuEx->Void)
	{
		super(X, Y);
		callback = Callback;
		header = Header;
...
enum FlxUIDropDownMenuExDropDirection
{
	Automatic;
	Down;
	Up;
